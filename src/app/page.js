...
export default function Home() {
  return (
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
      <div className="glass-panel fade-in" style={{ padding: "4rem 3rem", width: "100%", maxWidth: "600px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center" }}>
          <p className="mono-text" style={{ fontSize: "0.875rem", textTransform: "uppercase", letterSpacing: "2px", color: "var(--accent-cyan)" }}>
          ...
          <div style={{ display: "flex", gap: "1.5rem", marginTop: "1.5rem", width: "100%", justifyContent: "center" }}>
            <Link href="/login" style={{ flex: "1", maxWidth: "200px" }}>
              <button style={{ width: "100%", padding: "1rem", height: "100%" }}>AUTHENTICATE</button>
            </Link>
            <Link href="/register" style={{ flex: "1", maxWidth: "200px" }}>
              <button style={{ width: "100%", padding: "1rem", background: "rgba(0, 229, 255, 0.15)", height: "100%" }}>INITIALIZE NODE</button>
            </Link>
          </div>
        </div>
